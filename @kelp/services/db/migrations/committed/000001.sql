--! Previous: -
--! Hash: sha1:8bcdf5c365cc5749a2ff3658464ca9759e4c97db
...
--
CREATE OR REPLACE FUNCTION app_public.media_ready_for_copyright ()
  RETURNS SETOF app_public.media
  AS $$
  SELECT
    m
  FROM
...
--
CREATE FUNCTION app_public.set_slug_from_name ()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  SET search_path TO 'app_public', 'app_private', 'app_private', 'public'
  AS $$
...
--
CREATE FUNCTION app_public.set_slug_from_title ()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  SET search_path TO 'app_public', 'app_private', 'app_private', 'public'
  AS $$
...
--
CREATE FUNCTION app_public.slugify (value text)
  RETURNS text
  LANGUAGE sql
  IMMUTABLE STRICT
...
--
CREATE FUNCTION app_private.insert_crypto_key (i_cid text, i_user_id integer, i_is_primary boolean, i_private_key text, i_public_key text, i_fingerprint text, i_key_id text, i_implementation text, i_algorithm text, i_curve text, i_creation_time timestamp with time zone, i_expiration_time timestamp with time zone, i_revocation_certificate text, i_passphrase text)
  RETURNS app_public.crypto_keys
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO '$user', 'public'
  AS $$
...
--
CREATE FUNCTION app_private.link_or_register_user (f_user_id integer, f_service character varying, f_identifier character varying, f_profile json, f_auth_details json, f_is_email_verified boolean DEFAULT FALSE)
  RETURNS app_public.users
  LANGUAGE plpgsql
  SECURITY DEFINER
  SET search_path TO 'app_public', 'app_private', 'app_private', 'public'
...
--
CREATE FUNCTION app_private.really_create_user (username text, email text, email_is_verified boolean, name text, avatar_url text)
  RETURNS app_public.users
  LANGUAGE plpgsql
  SET search_path TO 'app_public', 'app_private', 'app_private', 'public'
  AS $$
...
--
CREATE FUNCTION app_private.tg__timestamps ()
  RETURNS TRIGGER
  LANGUAGE plpgsql
  SET search_path TO 'app_public', 'app_private', 'app_private', 'public'
  AS $$
...
--
CREATE UNIQUE INDEX uniq_user_emails_verified_email ON app_public.user_emails USING btree (email)
...
CREATE TRIGGER _100_timestamps
  BEFORE INSERT OR UPDATE ON app_public.album
  FOR EACH ROW
...
--
CREATE TRIGGER _100_timestamps
  BEFORE INSERT OR UPDATE ON app_public.crypto_keys
  FOR EACH ROW
  EXECUTE FUNCTION app_private.tg__timestamps ();
...
--
CREATE TRIGGER _100_timestamps
  BEFORE INSERT OR UPDATE ON app_public.device
  FOR EACH ROW
  EXECUTE FUNCTION app_private.tg__timestamps ();
...
--
CREATE TRIGGER _100_timestamps
  BEFORE INSERT OR UPDATE ON app_public.lightroom_catalog
  FOR EACH ROW
  EXECUTE FUNCTION app_private.tg__timestamps ();
...
--
CREATE TRIGGER _100_timestamps
  BEFORE INSERT OR UPDATE ON app_public.lightroom_collection
  FOR EACH ROW
  EXECUTE FUNCTION app_private.tg__timestamps ();
...
--
CREATE TRIGGER _100_timestamps
  BEFORE INSERT OR UPDATE ON app_public.lightroom_media
  FOR EACH ROW
  EXECUTE FUNCTION app_private.tg__timestamps ();
...
--
CREATE TRIGGER _100_timestamps
  BEFORE INSERT OR UPDATE ON app_public.media
  FOR EACH ROW
  EXECUTE FUNCTION app_private.tg__timestamps ();
...
--
CREATE TRIGGER _100_timestamps
  BEFORE INSERT OR UPDATE ON app_public.rendition
  FOR EACH ROW
  EXECUTE FUNCTION app_private.tg__timestamps ();
...
--
CREATE TRIGGER _200_lr_catalog_name_slug
  BEFORE INSERT OR UPDATE ON app_public.lightroom_catalog
  FOR EACH ROW
  EXECUTE FUNCTION app_public.set_slug_from_name ();

--
-- Name: crypto_keys _200_slug_name; Type: TRIGGER; Schema: app_public; Owner: -
--
CREATE TRIGGER _200_slug_name
  BEFORE INSERT OR UPDATE ON app_public.crypto_keys
  FOR EACH ROW
  EXECUTE FUNCTION app_public.set_slug_from_name ();
...
CREATE TRIGGER _200_slug_title
  BEFORE INSERT OR UPDATE ON app_public.album
  FOR EACH ROW
  EXECUTE FUNCTION app_public.set_slug_from_title ();
...
--
CREATE TRIGGER _100_timestamps
  BEFORE INSERT OR UPDATE ON app_private.crypto_key_secrets
  FOR EACH ROW
  EXECUTE FUNCTION app_private.tg__timestamps ();
...
--
CREATE POLICY delete_own ON app_public.album
  FOR DELETE
...
--
CREATE POLICY delete_own ON app_public.device
  FOR DELETE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY delete_own ON app_public.lightroom_catalog
  FOR DELETE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY delete_own ON app_public.lightroom_collection
  FOR DELETE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY delete_own ON app_public.lightroom_media
  FOR DELETE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY delete_own ON app_public.media
  FOR DELETE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY delete_own ON app_public.rendition
  FOR DELETE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY delete_self ON app_public.crypto_keys
  FOR DELETE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY insert_own ON app_public.album
  FOR INSERT
...
--
CREATE POLICY insert_own ON app_public.device
  FOR INSERT
    WITH CHECK ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY insert_own ON app_public.lightroom_media
  FOR INSERT
    WITH CHECK ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY insert_own ON app_public.media
  FOR INSERT
    WITH CHECK ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY insert_own ON app_public.rendition
  FOR INSERT
    WITH CHECK ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY insert_row ON app_public.lightroom_catalog
  FOR INSERT
    WITH CHECK ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY insert_row ON app_public.lightroom_collection
  FOR INSERT
    WITH CHECK (TRUE);
...
--
CREATE POLICY select_all ON app_public.crypto_keys
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY select_own ON app_public.album
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY select_own ON app_public.device
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY select_own ON app_public.lightroom_catalog
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY select_own ON app_public.lightroom_collection
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY select_own ON app_public.lightroom_media
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY select_own ON app_public.media
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY select_own ON app_public.rendition
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY update_own ON app_public.album
  FOR UPDATE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY update_own ON app_public.device
  FOR UPDATE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY update_own ON app_public.lightroom_catalog
  FOR UPDATE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY update_own ON app_public.lightroom_collection
  FOR UPDATE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY update_own ON app_public.lightroom_media
  FOR UPDATE
    WITH CHECK ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY update_own ON app_public.media
  FOR UPDATE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY update_own ON app_public.rendition
  FOR UPDATE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY update_self ON app_public.crypto_keys
  FOR UPDATE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY insert_own ON network.copyright
  FOR INSERT
    WITH CHECK ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY select_own ON network.copyright
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY delete_own ON app_private.crypto_key_secrets
  FOR DELETE
    USING ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY insert_own ON app_private.crypto_key_secrets
  FOR INSERT
    WITH CHECK ((user_id = app_public.current_user_id ()));
...
--
CREATE POLICY select_own ON app_private.crypto_key_secrets
  FOR SELECT
    USING ((user_id = app_public.current_user_id ()));
...
--
GRANT USAGE ON SCHEMA network TO :DATABASE_VISITOR;
...
--
GRANT SELECT, DELETE, UPDATE ON TABLE app_public.users TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_public."current_user" () TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_public.current_user_id () TO :DATABASE_VISITOR;

--
-- Name: TABLE media; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public.media TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_public.media_ready_for_copyright () TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_public.set_slug_from_name () TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_public.set_slug_from_title () TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_public.slugify (value text) TO :DATABASE_VISITOR;

--
-- Name: TABLE crypto_keys; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, DELETE, UPDATE ON TABLE app_public.crypto_keys TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_private.insert_crypto_key (i_cid text, i_user_id integer, i_is_primary boolean, i_private_key text, i_public_key text, i_fingerprint text, i_key_id text, i_implementation text, i_algorithm text, i_curve text, i_creation_time timestamp with time zone, i_expiration_time timestamp with time zone, i_revocation_certificate text, i_passphrase text) TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_private.link_or_register_user (f_user_id integer, f_service character varying, f_identifier character varying, f_profile json, f_auth_details json, f_is_email_verified boolean) TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_private.really_create_user (username text, email text, email_is_verified boolean, name text, avatar_url text) TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_private.register_user (f_service character varying, f_identifier character varying, f_profile json, f_auth_details json, f_email_is_verified boolean) TO :DATABASE_VISITOR;
...
GRANT ALL ON FUNCTION app_private.tg__timestamps () TO :DATABASE_VISITOR;

--
-- Name: TABLE _album_lightroom_collection; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public._album_lightroom_collection TO :DATABASE_VISITOR;

--
-- Name: TABLE _album_media; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public._album_media TO :DATABASE_VISITOR;

--
-- Name: TABLE _lightroom_media_uniqueness; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public._lightroom_media_uniqueness TO :DATABASE_VISITOR;

--
-- Name: TABLE _media_device; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public._media_device TO :DATABASE_VISITOR;

--
-- Name: TABLE album; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public.album TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE album_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.album_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE crypto_keys_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.crypto_keys_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE device; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public.device TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE device_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.device_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE lightroom_catalog; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public.lightroom_catalog TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE lightroom_catalogs_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.lightroom_catalogs_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE lightroom_collection; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public.lightroom_collection TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE lightroom_collection_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.lightroom_collection_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE lightroom_media; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public.lightroom_media TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE lightroom_media_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.lightroom_media_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE media_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.media_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE rendition; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE app_public.rendition TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE rendition_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.rendition_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE user_authentications; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, DELETE ON TABLE app_public.user_authentications TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE user_authentications_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.user_authentications_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE user_emails; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, DELETE ON TABLE app_public.user_emails TO :DATABASE_VISITOR;

--
-- Name: COLUMN user_emails.email; Type: ACL; Schema: app_public; Owner: -
--
GRANT INSERT (email) ON TABLE app_public.user_emails TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE user_emails_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.user_emails_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE users_id_seq; Type: ACL; Schema: app_public; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_public.users_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE copyright; Type: ACL; Schema: network; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE network.copyright TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE copyright_id_seq; Type: ACL; Schema: network; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE network.copyright_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE pending_tx; Type: ACL; Schema: network; Owner: -
--
GRANT SELECT, INSERT, DELETE, UPDATE ON TABLE network.pending_tx TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE pending_tx_id_seq; Type: ACL; Schema: network; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE network.pending_tx_id_seq
  TO :DATABASE_VISITOR;

--
-- Name: TABLE crypto_key_secrets; Type: ACL; Schema: app_private; Owner: -
--
GRANT SELECT, INSERT, DELETE ON TABLE app_private.crypto_key_secrets TO :DATABASE_VISITOR;

--
-- Name: SEQUENCE crypto_key_secrets_id_seq; Type: ACL; Schema: app_private; Owner: -
--
GRANT SELECT, USAGE ON SEQUENCE app_private.crypto_key_secrets_id_seq
  TO :DATABASE_VISITOR;
...
ALTER DEFAULT PRIVILEGES FOR ROLE kelp_owner IN SCHEMA app_public GRANT
SELECT
, USAGE ON SEQUENCES TO :DATABASE_VISITOR;
...
ALTER DEFAULT PRIVILEGES FOR ROLE kelp_owner IN SCHEMA app_public GRANT ALL ON FUNCTIONS TO :DATABASE_VISITOR;
...
ALTER DEFAULT PRIVILEGES FOR ROLE kelp_owner IN SCHEMA network GRANT
SELECT
, USAGE ON SEQUENCES TO :DATABASE_VISITOR;
...
ALTER DEFAULT PRIVILEGES FOR ROLE kelp_owner IN SCHEMA public GRANT
SELECT
, USAGE ON SEQUENCES TO :DATABASE_VISITOR;
...
ALTER DEFAULT PRIVILEGES FOR ROLE kelp_owner IN SCHEMA public GRANT ALL ON FUNCTIONS TO :DATABASE_VISITOR;
...
ALTER DEFAULT PRIVILEGES FOR ROLE kelp_owner IN SCHEMA app_private GRANT
SELECT
, USAGE ON SEQUENCES TO :DATABASE_VISITOR;
...
ALTER DEFAULT PRIVILEGES FOR ROLE kelp_owner IN SCHEMA app_private GRANT ALL ON FUNCTIONS TO :DATABASE_VISITOR;
