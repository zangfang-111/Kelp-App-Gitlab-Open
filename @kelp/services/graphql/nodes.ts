...
export const IsLoggedInQuery = gql`
  ...
  isLoggedIn @client
    ...
    `;
export const ActiveNotification = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetAlbums(variables?: GetAlbumsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: GetAlbumsQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetAlbumsQuery>(GetAlbumsDocument, variables, requestHeaders));
    },
    GetAlbumDetails(variables: GetAlbumDetailsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: GetAlbumDetailsQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetAlbumDetailsQuery>(GetAlbumDetailsDocument, variables, requestHeaders));
    },
    UpdateMediaCopyright(variables: UpdateMediaCopyrightMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: UpdateMediaCopyrightMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<UpdateMediaCopyrightMutation>(UpdateMediaCopyrightDocument, variables, requestHeaders));
    },
    GetMyCryptoKeysBasic(variables?: GetMyCryptoKeysBasicQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: GetMyCryptoKeysBasicQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetMyCryptoKeysBasicQuery>(GetMyCryptoKeysBasicDocument, variables, requestHeaders));
    },
    GetMyCryptoKeysExtended(variables?: GetMyCryptoKeysExtendedQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: GetMyCryptoKeysExtendedQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetMyCryptoKeysExtendedQuery>(GetMyCryptoKeysExtendedDocument, variables, requestHeaders));
    },
    MyDevices(variables?: MyDevicesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: MyDevicesQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<MyDevicesQuery>(MyDevicesDocument, variables, requestHeaders));
    },
    PoCloForVerification(variables?: PoCloForVerificationQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: PoCloForVerificationQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<PoCloForVerificationQuery>(PoCloForVerificationDocument, variables, requestHeaders));
    },
    AddOwnershipToDevices(variables: AddOwnershipToDevicesMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: AddOwnershipToDevicesMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<AddOwnershipToDevicesMutation>(AddOwnershipToDevicesDocument, variables, requestHeaders));
    },
    IsLoggedInQuery(variables?: IsLoggedInQueryQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: IsLoggedInQueryQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<IsLoggedInQueryQuery>(IsLoggedInQueryDocument, variables, requestHeaders));
    },
    ActiveNotification(variables?: ActiveNotificationQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: ActiveNotificationQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<ActiveNotificationQuery>(ActiveNotificationDocument, variables, requestHeaders));
    },
    SelectedMedia(variables?: SelectedMediaQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: SelectedMediaQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<SelectedMediaQuery>(SelectedMediaDocument, variables, requestHeaders));
    },
    MediaPreview(variables: MediaPreviewQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: MediaPreviewQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<MediaPreviewQuery>(MediaPreviewDocument, variables, requestHeaders));
    },
    MediaKeywords(variables: MediaKeywordsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: MediaKeywordsQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<MediaKeywordsQuery>(MediaKeywordsDocument, variables, requestHeaders));
    },
    MediaCopyrights(variables: MediaCopyrightsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: MediaCopyrightsQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<MediaCopyrightsQuery>(MediaCopyrightsDocument, variables, requestHeaders));
    },
    MediaReadyForCopyright(variables?: MediaReadyForCopyrightQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: MediaReadyForCopyrightQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<MediaReadyForCopyrightQuery>(MediaReadyForCopyrightDocument, variables, requestHeaders));
    },
    CreateRendition(variables: CreateRenditionMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: CreateRenditionMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<CreateRenditionMutation>(CreateRenditionDocument, variables, requestHeaders));
    },
    GetRenditionByCid(variables: GetRenditionByCidQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: GetRenditionByCidQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetRenditionByCidQuery>(GetRenditionByCidDocument, variables, requestHeaders));
    },
    TimelineMedia(variables: TimelineMediaQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: TimelineMediaQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<TimelineMediaQuery>(TimelineMediaDocument, variables, requestHeaders));
    },
    ...
    LightroomCatalog(variables: LightroomCatalogQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: LightroomCatalogQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<LightroomCatalogQuery>(LightroomCatalogDocument, variables, requestHeaders));
    },
    SyncLightroomCatalog(variables: SyncLightroomCatalogMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: SyncLightroomCatalogMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<SyncLightroomCatalogMutation>(SyncLightroomCatalogDocument, variables, requestHeaders));
    },
    SyncLightroomCollection(variables: SyncLightroomCollectionMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: SyncLightroomCollectionMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<SyncLightroomCollectionMutation>(SyncLightroomCollectionDocument, variables, requestHeaders));
    },
    SyncLightroomMedia(variables: SyncLightroomMediaMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: SyncLightroomMediaMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<SyncLightroomMediaMutation>(SyncLightroomMediaDocument, variables, requestHeaders));
    },
    LightroomRemoveMediaFromCollection(variables: LightroomRemoveMediaFromCollectionMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: LightroomRemoveMediaFromCollectionMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<LightroomRemoveMediaFromCollectionMutation>(LightroomRemoveMediaFromCollectionDocument, variables, requestHeaders));
    },
    SyncRendition(variables: SyncRenditionMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: SyncRenditionMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<SyncRenditionMutation>(SyncRenditionDocument, variables, requestHeaders));
    },
    GetRenditionByCidWithMedia(variables: GetRenditionByCidWithMediaQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: GetRenditionByCidWithMediaQuery | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<GetRenditionByCidWithMediaQuery>(GetRenditionByCidWithMediaDocument, variables, requestHeaders));
    },
    CreateDevice(variables: CreateDeviceMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data?: CreateDeviceMutation | undefined; extensions?: any; headers: Dom.Headers; status: number; errors?: GraphQLError[] | undefined; }> {
        return withWrapper(() => client.rawRequest<CreateDeviceMutation>(CreateDeviceDocument, variables, requestHeaders));
    }
  };
}
